...
Status op 2026-08-16: **CLIENT INVALID / BLOCKED**.
...
- Clientpad dat is geinspecteerd: `/Users/ceesvisser/WOC/wow-client-3.3.5a`
...
Niet geinstalleerd in deze ronde, omdat de client niet geldig is. Eerst moet
er een speelklare clientmap met `Wow.exe` en `Data/realmlist.wtf` zijn.

Actuele voorkeursroute voor een gratis runtime:

1. **Sikarugir**: gratis/open-source Wine-wrapper, opvolger van
   Wineskin/Kegworks, ondersteunt Apple Silicon en gebruikt Homebrew-cask
   installatie.
...
Lever een speelklare, legitiem verkregen WotLK clientmap aan met minimaal:
...
Daarna opnieuw valideren:

- build `3.3.5a 12340`
- locale
- MPQ/clientdata
- realmlist-backup en configuratie
- gratis Wine/Sikarugir/Whisky runtime
